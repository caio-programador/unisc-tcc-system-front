import { Center, Box, Stack, Heading, Button, VStack } from "@chakra-ui/react";
...
export default function Register({ 
  ...
  return (
    <Center minH="100vh" py={8}>
      <Box p="6" borderWidth="1px" borderRadius="lg" overflow="hidden" boxShadow="md" w="full" maxW="md">
        <Stack gap={4}>
          <Heading size="lg" textAlign="center">Cadastro da Faculdade</Heading>
