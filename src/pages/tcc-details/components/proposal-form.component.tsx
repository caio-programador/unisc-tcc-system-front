...
export const ProposalForm = ({ 
  ...
  const { register, handleSubmit, formState: { errors } } = useFormContext<ProposalFormData>();
  ...
  return (
    <Card.Root bg="transparent" border="2px solid" borderColor="textPrimary" borderRadius="lg">
      <Card.Header>
        <Heading size="md" color="textPrimary">Publicar Proposta</Heading>
        ...
        <Box as="form" onSubmit={handleSubmit(handleFormSubmit)}>
          <VStack gap={4} align="stretch">
            <Field.Root invalid={Boolean(errors.title)}>
              <Field.Label htmlFor="title" color="textPrimary">Título do TCC</Field.Label>
              <Input 
                id="title"
            ...
            <Field.Root invalid={Boolean(errors.file)}>
              <Field.Label htmlFor="file" color="textPrimary">Arquivo da Proposta</Field.Label>
                      ...
                      <>
                        <Text color="textPrimary" fontSize="sm" fontWeight="medium">
                          {selectedFileName}
                           ...
                           p={0.5}
                           m={0.5}
                           _hover={{color: "red.500", backgroundColor: "red.500"}}
                           alignItems="center"
                           justifyContent="center"
                         >
                          <FaRegTrashAlt />
